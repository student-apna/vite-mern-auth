  ...
  return (
    ...
    px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <form  onSubmit={onSubmitHandler} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <p className="text-center mb-6 text-indigo-300">Enter a 6-digit code sent to your email id.</p>
        ...
        <button className="w-full py-3 bg-gradient-to-r
         from-indigo-500 to-indigo-900 text-white rounded-full">Verify email</button>
